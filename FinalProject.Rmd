...
GO_mep50_down <- vroom("~/BCHM421_FinalProject/GOrilla Results/GO_mep50_down.txt", delim="\t", col_names=TRUE)
GO_mep50_up <- vroom("~/BCHM421_FinalProject/GOrilla Results/GO_mep50_up.txt", delim="\t", col_names=TRUE)
GO_prmt5_down <- vroom("~/BCHM421_FinalProject/GOrilla Results/GO_prmt5_down.txt", delim="\t", col_names=TRUE)
GO_prmt5_up <- vroom("~/BCHM421_FinalProject/GOrilla Results/GO_prmt5_up.txt", delim="\t", col_names=TRUE)
